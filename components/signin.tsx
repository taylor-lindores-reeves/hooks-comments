...
import { Label } from "@hooks-comments/components/ui/label";
import { Input } from "@hooks-comments/components/ui/input";
...
const SignIn: React.FC = () => {
	...
	return (
		<form onSubmit={handleSubmit} className="space-y-4 w-96 mx-auto py-4">
